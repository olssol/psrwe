...
#'
#'
#' @param dta_psbor A class \code{RWE_PS_BOR} object generated by
#'     \code{\link{rwe_ps_borrow}}.
...
#'
#' @return A class \code{RWE_PS_RST} list with the following objects
#'
#' \describe{
#'
...
#' @export
#'
rwe_ps_powerp <- function(dta_psbor, v_outcome = "Y",
...
#'
#' @method summary RWE_PS_RST
#'
#'
#' @export
#'
summary.RWE_PS_RST <- function(object, ...) {
