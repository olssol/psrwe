#' Call STAN models
#'
#' Call STAN models. Called by \code{ps_rwe_powerp}.
#'
...
#'
#'
#' @param dta_psbor A class \code{PS_RWE_BOR} object generated by
#'     \code{\link{ps_rwe_borrow}}.
...
#'
#' @return A class \code{PS_RWE_RST} list with the following objects
#'
#' \describe{
#'
...
#' rst <- ps_rwe_powerp(ps_borrow, v_outcome = "Y_Con", seed = 123)}
#'
#' @export
#'
ps_rwe_powerp <- function(dta_psbor, v_outcome = "Y",
...
#'
#'
#' @param object A list of class \code{PS_RWE_RST} that is generated using the
#'     \code{\link{ps_rwe_powerp}}, \code{\link{ps_rwe_compl}}, or
#'     \code{\link{ps_rwe_survkm}} function.
#' @param ... Additional parameters.
#'
#' @return A list with data frames for the borrowing and estimation results.
#'
#' @method summary PS_RWE_RST
#'
#'
#' @export
#'
summary.PS_RWE_RST <- function(object, ...) {
...
#'
#' @param x A list of class \code{PS_RWE_RST} that is generated using the
#'     \code{\link{ps_rwe_powerp}}, \code{\link{ps_rwe_compl}}, or
#'     \code{\link{ps_rwe_survkm}} function.
#' @param ... Additional parameters
#'
#' @seealso  \code{\link{summary.PS_RWE_RST}}
#'
#'
#' @method print PS_RWE_RST
#'
#'
#' @export
#'
...
#'
#'
#' @method plot PS_RWE_RST
#'
#'
#' @export
#'
plot.PS_RWE_RST <- function(x, ...) {
    rst <- switch(x$Method,
                  ps_pp = plot_pp_rst(x, ...),
                  ps_km = plot_km_rst(x, ...),
                  ps_cl = {
